...
if [ -f $0.cfg ] ;then
    ...
    echo "URL=\"http://it-userdesk.de/dl/mediathek/radio/notyetspecified.mp3\"" > $0.cfg
...
sleep 10
# back to lissi mainmenu
adb -s $DEVICE shell am start -a android.intent.action.VIEW -d http://192.168.2.201:1880/ui/
echo "LISSI CALL"
